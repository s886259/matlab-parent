...
/**
 * Downloaded from http://www.ngdc.noaa.gov/geomag/WMM/thirdpartycontributions.shtml
 * on 26 April, 2011. 
 * <p>
...
public class TSAGeoMag
{
    ...
    private void InitModel()
    {
        ...
        try{
            ...
            while(true){
                str.nextToken();
//                System.out.println(str.toString() + " " + str.nval);
                if(str.nval >= 9999)
                    break;
...
//                System.out.println(String.format("n = %d, m = %d, gnm = %3.1f, dgnm = %3.1f",
//                		n, m, gnm, dgnm));
                if (m <= n)
                {
                    c[m][n] = gnm;
        ...
        // rather than catching all exceptions.	  
            ...
            System.out.println("The input file WMM.COF was not found in the same directory as the application.");
            System.out.println("The magnetic field components are set to internal values.");
            System.out.println("The file WMM.COF can be downloaded from http://www.ngdc.noaa.gov/geomag/WMM/soft.shtml");
    ...
    public static void main(String [] args)
    {
        ...
        TSAGeoMag testCase = new TSAGeoMag();
         // is is the latitude, j is the longitude, k is the altitude
