...
public class ChannelPanel implements ActionListener, ListSelectionListener {
	...
	private void editChannelList() {
		 ...
		 */
		Integer newChannel = (Integer) JOptionPane.showInputDialog(arrayDialog, "Select hydrophone for ADC channel " + selRow,
				new String("ADC Channel " + selRow), JOptionPane.OK_CANCEL_OPTION, null, options, 
				new Integer(hydrophoneList[selRow]));
