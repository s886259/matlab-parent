...
import PamUtils.PamUtils;
 ...
 abstract public class AbstractTimeDelayLocaliser<T extends PamDetection> extends AbstractTargetMotionModel<T>{
	 
	 
	 	//Event Info
	 
		protected ArrayList<PamDetection> currentDetections;
		 ...
		 * @param pamDetection
		 */
		public void getEventInfo(PamDetection pamDetection){
			
			nSubDetections = pamDetection.getSubDetectionsCount();
			currentDetections=new ArrayList<PamDetection>();
		...
		public void setEventRotator(PamDetection pamDetection){
