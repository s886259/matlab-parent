...
import Localiser.timeDelayLocalisers.MCMCTDResults;
...
public class MarkovChain<T extends PamDetection>  extends AbstractTimeDelayLocaliser<T> implements PamSettings {
	...
	private MCMC mCMC=new MCMC(settings);
...
//	}
	...
	public TargetMotionResult[] runModel(T pamDetection) {
		...
		tmResults[i] = new TargetMotionResult(this, ll, 0, finalResults.get(i).getChi());
