...
public class TableUtilities {
	...
	public static boolean columnExists(Connection con, String tableName, String columnName, int sqlType) {
...
//			return false;
	...
	public static boolean tableExists(Connection con, String systemName, EmptyTableDefinition tableDef) {
		try {
			DatabaseMetaData dbm = con.getMetaData();
