...
public class LookupEditDialog extends PamDialog {
	...
	private LUTDataModel lutTableData;
	...
	private LookupEditDialog(Window parentFrame) {
		...
		lutTableData = new LUTDataModel();
		lutTable = new LUTTable(lutTableData);
...
//		eastTop.setLayout(new BoxLayout(eastTop, BoxLayout.Y_AXIS));
	...
	public static LookupList showDialog(Window parentFrame, LookupList lookupList) {
		...
		singleInstance.lutTableData.fireTableDataChanged();
	...
	private void addItem() {
		...
		lutTableData.fireTableDataChanged();
	}
...
//	}
	...
	private class LUTTable extends JTable {
		...
		public LUTTable(LUTDataModel lutTableData) {
			super(lutTableData);
	...
	private class LUTDataModel extends AbstractTableModel {
