 ...
 * description will apear in the Display / Symbols menu from where it is
 ...
 * 
 */
public class PamSymbolManager implements PamSettings, Serializable {
...
//	private Frame guiFrame;
	...
	static public PamSymbolManager getInstance() {
		if (singleInstance == null) {
			singleInstance = new PamSymbolManager();
		}
