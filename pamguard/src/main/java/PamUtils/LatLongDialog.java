...
public class LatLongDialog extends PamDialog implements ActionListener {
	...
	private LatLongDialog(Frame parentFrame, String title) {
	...
	public static LatLong showDialog(Frame parentFrame, LatLong latLong, String title) {
