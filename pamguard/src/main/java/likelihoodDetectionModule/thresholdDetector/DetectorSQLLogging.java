...
public class DetectorSQLLogging extends SQLLogging {
	...
	public PamTableDefinition createTableDefinition() {
		...
		PamTableDefinition tableDef = new PamTableDefinition(likelihoodController.getUnitName(), getUpdatePolicy());
...
//		PamTableItem dateItem, durationItem, lowFreqItem, highFreqItem, energyItem;
		...
		durationItem.setValue((double) wdu.getDuration() / thresholdDetectorProcess.getSampleRate());
