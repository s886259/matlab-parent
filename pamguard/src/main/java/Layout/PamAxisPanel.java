...
//		Rectangle innerRectangle = new Rectangle(getSize());
//		if (innerComponent != null) {
//			Rectangle innerBounds = innerComponent.getBounds();
//			newInsets.left = innerBounds.x;
//			newInsets.top = innerBounds.y;
//			
//		}
		...
		if (northAxis != null) {
			northAxis.drawAxis(g, newInsets.left, newInsets.top, panelRight,
					newInsets.top);
		}
		if (westAxis != null) {
			westAxis.drawAxis(g, newInsets.left, panelBottom, newInsets.left,
					newInsets.top);
		}
		if (southAxis != null) {
			southAxis.drawAxis(g, newInsets.left, panelBottom, panelRight,
					panelBottom);
		}
		if (eastAxis != null) {
