...
public class BearingTimeOptionsDialog  extends PamDialog{
			
		private JPanel mainPanel;
		private BearingAmpAxis bearingAmplitudeAxis;
		private static BearingTimeOptionsDialog singleInstance;
		...
		public BearingTimeOptionsDialog(Window parentFrame, Point location, BTAxisParams params) {
		...
		public static BTAxisParams showDialog(Window frame, Point pt, BTAxisParams params){
			if (singleInstance == null || singleInstance.getOwner() != frame) {
				singleInstance = new BearingTimeOptionsDialog(frame, pt,  params);
			}
