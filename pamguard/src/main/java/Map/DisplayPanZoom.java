...
public class DisplayPanZoom extends JPanel {
	...
	public DisplayPanZoom() {
		...
		upLeft = new JButton("", new ImageIcon(ClassLoader
		...
		left = new JButton("", new ImageIcon(ClassLoader
		...
		right = new JButton("", new ImageIcon(ClassLoader
		...
		downLeft = new JButton("", new ImageIcon(ClassLoader
		...
		down = new JButton("", new ImageIcon(ClassLoader
		...
		downRight = new JButton("", new ImageIcon(ClassLoader
		...
		headUp = new JButton("", new ImageIcon(ClassLoader
				.getSystemResource("Resources/PamPanZoomHeadUp.png")));
		// headUp = new JButton("",new ImageIcon("PamPanZoomHeadUp.png"));
		headUp.setToolTipText("rotate map to head-up");

		northUp = new JButton("", new ImageIcon(ClassLoader
				.getSystemResource("Resources/PamPanZoomNorthUp.png")));
		// northUp = new JButton("",new ImageIcon("PamPanZoomNorthUp.png"));
		northUp.setToolTipText("rotate map to north-up");

		centreOnShip = new JButton("", new ImageIcon(ClassLoader
		...
		rotateClockwise = new JButton("", new ImageIcon(ClassLoader
		...
		rotateAntiClockwise = new JButton("", new ImageIcon(ClassLoader
		...
		panWithMouse = new JButton(new ImageIcon(ClassLoader
				.getSystemResource("Resources/PanWithMouse.png")));
		panWithMouse.setToolTipText("Drag display with mouse");
		measureWithMouse = new JButton(new ImageIcon(ClassLoader
...
//		add(downRight);
		...
		setPreferredSize(new Dimension(3 * 40 + 10, 3 * 40 + 10));
