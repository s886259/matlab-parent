...
public class Compass {
	...
	public void drawCompass(Graphics2D g2d, MapRectProjector rectProj) {
		...
		compassColor = new Color(216, 216, 216);
		fontColor = new Color(200, 150, 150);
		northColor = new Color(150, 150, 190);
		mountColor = new Color(186, 150, 95);
		...
		arrowTail = TransformUtilities.rotationDegreesXYZ(arrowTail,
				mapRotationDegrees);
		arrowTail.x = compassCentre.x - arrowTail.x;
		arrowTail.y = compassCentre.y + arrowTail.y;
		arrowHead = TransformUtilities.rotationDegreesXYZ(arrowHead,
				mapRotationDegrees);
		arrowHead.x = compassCentre.x - arrowHead.x;
		arrowHead.y = arrowHead.y + compassCentre.y;
		arrowHeadEndLeft = TransformUtilities.rotationDegreesXYZ(
		...
		arrowHeadEndRight = TransformUtilities.rotationDegreesXYZ(
