...
public class LandmarkDialog extends PamDialog {
	...
	private LandmarkDialog(Frame parentFrame,LandmarkControl landmarkControl) {
	...
	public static LandmarkData showDialog(Frame parentFrame, LandmarkControl landmarkControl, LandmarkData landmarkData) {
