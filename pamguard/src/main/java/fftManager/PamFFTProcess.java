...
//						null, channelCounts[iChan]);
				...
				fftOutData = fastFFT.rfft(fftRealBlock, fftOutData,
						logFftLength);
...
//					outputData.addPamData(null);
	...
	public void makeAnnotations() {
		...
		if (fftControl.fftParameters.clickRemoval) {
			fftAnnotations.add(new Annotation(this, clickRemoval, fftControl.getUnitType(), "Click Removal"));
		}
	...
	class TempOutputStore {
		...
		private void addData(FFTDataUnit fftData) {
