...
public class FormsDataUnitEditDialog extends PamDialog{
	...
	private FormsDataUnitEditDialog(Window parentFrame, FormDescription formDescription) {
		...
		JLabel warning = new JLabel("You are changing stored data from " + formDescription.getFormNiceName(), JLabel.CENTER);
	...
	public boolean getParams() {
		...
		Object[] newData = loggerForm.transferControlDataToArray();
