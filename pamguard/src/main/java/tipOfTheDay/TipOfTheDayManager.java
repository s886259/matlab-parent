...
public class TipOfTheDayManager {
	...
	private TipOfTheDayManager() {
		...
		addTipRandom(new PamTip("Thoughts from my late father", "We live in three dimensions: Space, time and doubt. " +
		...
		addTipRandom(new PamTip("64 bit processing", "Full 64 bit support is still under development.\n" +
				"Even if you have a 64 bit cmputer, you will probably be better off running a 32 bit Java Virtual Machine"));
