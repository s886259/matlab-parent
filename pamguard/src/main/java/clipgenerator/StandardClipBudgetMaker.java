...
public class StandardClipBudgetMaker {
	 ...
	 */
	public boolean shouldStore(AcousticDataUnit dataUnit) {
	 ...
	 */
	public double getStorageProbability(AcousticDataUnit dataUnit) {
	 ...
	 */
	private int getClipSize(AcousticDataUnit dataUnit) {
		ClipGenSetting cgs = clipBlockProcess.clipGenSetting;
		int nSamples = (int) (dataUnit.getDuration() +  sampleRate * (cgs.preSeconds+cgs.postSeconds));
