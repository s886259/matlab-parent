...
public class ClipGenSettingDialog extends PamDialog {
	...
	public static ClipGenSetting showDialog(Window parent, ClipGenSetting clipGenSetting, PamDataBlock parentDataBlock) {
		if (singleInstance == null || singleInstance.getOwner() != parent) {
			singleInstance = new ClipGenSettingDialog(parent, parentDataBlock.getDataName());
		}
		singleInstance.setTitle(parentDataBlock.getDataName());
		if (clipGenSetting == null) {
			clipGenSetting = new ClipGenSetting(parentDataBlock.getDataName());
		}
