...
public class BTAmplitudeSelector implements PamDialogPanel {
	...
	class HistoOverLayer implements HistogramGraphicsLayer {
		...
		PamSymbol upT = new PamSymbol(PamSymbol.SYMBOL_TRIANGLEU, SYMSIZE, SYMSIZE, true, Color.RED, Color.RED);
		PamSymbol dnT = new PamSymbol(PamSymbol.SYMBOL_TRIANGLED, SYMSIZE, SYMSIZE, true, Color.RED, Color.RED);
