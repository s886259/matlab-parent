...
//		allNmeaData.addObserver(this);
		...
		aisDataBlock.setLocalisationContents(AbstractLocalisation.HAS_BEARING | AbstractLocalisation.HAS_DEPTH |
				AbstractLocalisation.HAS_LATLONG | AbstractLocalisation.HAS_RANGE);
