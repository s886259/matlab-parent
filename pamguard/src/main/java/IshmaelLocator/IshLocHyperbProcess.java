...
public class IshLocHyperbProcess extends IshLocProcess {
	...
	@Override
	IshLocalisation calcData(PamDetection outputUnit, int referencePhones, 
...
*/
		...
		IshLocalisation iLoc = new IshLocalisation(outputUnit, AbstractLocalisation.HAS_LATLONG,
				referencePhones);
		iLoc.setLocContents((nDim == 2) ? AbstractLocalisation.HAS_XY : AbstractLocalisation.HAS_XYZ);
		iLoc.addLocContents(AbstractLocalisation.HAS_LATLONG);
