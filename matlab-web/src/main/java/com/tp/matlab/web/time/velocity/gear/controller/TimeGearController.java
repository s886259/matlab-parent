package com.tp.matlab.web.time.velocity.gear.controller;
...
@Slf4j
@RestController
@RequestMapping(value = "/api/v1/time/velocity/gear")
@RequiredArgsConstructor
@Api(value = "速度时域图（齿轮）", tags = "速度时域图（齿轮）")
public class TimeGearController {

    private final TimeGearService timeGearService;
    ...
    private ResponseEntity<TimeVelocityResponse> execute(
        ...
        final TimeVelocityResponse response = toValue(timeGearService.execute(records), TimeVelocityResponse.class);
