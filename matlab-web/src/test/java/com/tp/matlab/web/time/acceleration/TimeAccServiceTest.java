...
@SpringBootTest
public class TimeAccServiceTest {

    @Autowired
    private TimeAccService timeAccService;
    ...
    private void test(String file) throws InvalidFormatException, IOException {
        //my output
        ...
        timeAccService.execute(records);
    }
}
