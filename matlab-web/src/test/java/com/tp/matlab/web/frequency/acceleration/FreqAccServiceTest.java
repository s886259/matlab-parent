package com.tp.matlab.web.frequency.acceleration;

import com.tp.matlab.kernel.util.ExcelUtils;
import com.tp.matlab.kernel.util.FileUtils;
import com.tp.matlab.web.frequency.envolope.service.FreqAccService;
...
@SpringBootTest
public class FreqAccServiceTest {
    ...
    public void testMain() throws IOException, InvalidFormatException {
        ...
        FreqAccService.execute(records);
    }
}
