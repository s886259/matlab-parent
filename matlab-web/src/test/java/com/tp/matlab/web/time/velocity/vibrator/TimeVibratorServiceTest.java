package com.tp.matlab.web.time.velocity.vibrator;
...
@SpringBootTest
public class TimeVibratorServiceTest {

    @Autowired
    private TimeVibratorService timeVibratorService;
    ...
    public void testMain() throws IOException, InvalidFormatException {
        ...
        timeVibratorService.execute(records);
    }
}
